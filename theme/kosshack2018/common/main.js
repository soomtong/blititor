...
function windowLoadInit() {
	...
	if (jQuery().countdown) {
		...
		var openingDate = new Date('2018-07-18 15:50');
		jQuery('#coming-soon-countdown').countdown({ until: openingDate });
	}
    ...
    jQuery('.smooth-link').on('click', 'li>a', function( e ) {
        e.preventDefault();
        // $window.scrollTo(this.hash, 800);
        var $thisLink = jQuery(this);
        $window.scrollTo($thisLink.attr('href'), 800);
        $window.scrollTo('-=120px', 400);
    });
